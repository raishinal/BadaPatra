                            ...
                            <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="name" data-sortable="true">Item Title</th>
                                ...
                                <tbody>
                                    <c:forEach items="${itemlist}" var="item">
                                        <tr>
                                            ...
                                            <td><a href="<c:url value="/Admin/Document/Edit/${item.id}"/>">Edit</a></td>
                                            <td><a href="<c:url value="/Admin/Document/Delete/${item.id}"/>" onclick="return confirm('Are you sure?')">Delete</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
